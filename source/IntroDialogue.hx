	...
	public function chooseDialogue(Option:Int):Void{
		...
		switch dialogueIndex {
			case 1: {
				...
				Names = ["Nizaemon", "Nizaemon", "Nizaemon", "","Shimotsuki", "Nizaemon", "Shimotsuki", "Nizaemon", "Shimotsuki", "Shimotsuki", "Nizaemon", "Nizaemon", "Nizaemon", "Shimotsuki", "Nizaemon","Shimotsuki", "Nizaemon", "Nizaemon", "Nizaemon",
				"Shimotsuki", "Nizaemon", "Nizaemon", "Nizaemon", "","Shimotsuki", "Nizaemon", "Nizaemon"];
			}
			case 2:{
				// 9.6
				Texts = ["What is...", "I need some information.", "Oh, I didn't expect that.", "Do you ever heard of my brother?", "You have a brother?", "So you do know him.", "Who you think I am", "You know who he has been working for?", "A boss who doesn't like his minions to have family.", "Who is his next target?", "You.", "Is he a politician?",
				...
				Names = ["Yamamoto", "Shimotsuki", "Yamamoto", "Shimotsuki", "Yamamoto", "Shimotsuki", "Yamamoto", "Shimotsuki", "Yamamoto", "Shimotsuki", "Yamamoto", "Shimotsuki", "Yamamoto", "Shimotsuki", "Yamamoto", "Shimotsuki", "Yamamoto", "Yamamoto", "Yamamoto", "Shimotsuki", "Yamamoto", "Yamamoto", "Yamamoto", "Shimotsuki", "Yamamoto"];
			}
			case 3:{
				// 9.7
				//"next to Shimotsuki"
				Texts = ["I…I have some very urgent information", "We are in a big trouble!", "Please, calm down, both of you.", "Yamamoto San, you go first", "It is not fair!",
			...
			case 4:{
				//9.8
				Texts = ["It is still very hot though."," Do not say a word"," Do not say which word","Nothing","It's true","Kawako?","(Smiling)","Okay, I will tell the truth.","Tsuruko caught a cold"," Very serious one","Is that true","(Smiling at Setsuko)","It is also true","Please…","You are not going to work today Tsuruko,","But…","You have to learn to take care of yourself","Okay…","Go and have some rest, it is an order.","Yes ma'am.","Shimotsuki leaving the room","Because there is one day that I'm no longer with you."];
				Names = ["Kawako","Tsuruko","Shimotsuki","Kawako","Setsuko","Shimotsuki","Shimotsuki","Kawako","Kawako","Kawako","Shimotsuki","Shimotsuki","Setsuko","Tsuruko","Shimotsuki","Tsuruko","Shimotsuki","Tsuruko","Shimotsuki","Tsuruko","","Shimotsuki"];
	
			}
			case 5:{
				//9.9
				Texts = ["What is this?","This is the lock on the safe!","Why is it here?","What about the safe?","It is empty..","It is true.","So it was a thief, not a cat.","Kawako, don’t be so upset","That was only a small amount.","So we didn’t lose much?","No. I keep most of them in a safer place."," It is true."];
				Names = ["Kawako","Tsuruko","Kawako","Tsuruko","Kawako","Setsuko","Shimotsuki","Shimotsuki","Shimotsuki","Kawako","Shimotsuki","Setsuko"];
	
			}
			case 6 :{
				//9.11
				Texts = ["Borrowed for two days, sorry, here is the money and the interests.","What is this","The money appear in the safe again","with this note"," So it is a thief that returns money","it is true","It is so strange.","Anyway the money is back.","…","Tachibana Sama?","Nothing","(Is it you again… but thank you anyway)","(You are truly a good man, Yamamoto)"];
				Names = ["Tsuruko","Shimotsuki","Tsuruko","Tsuruko","Kawako","Setsuko","Tsuruko","Kawako","Shimotsuki","Kawako","Shimotsuki","Shimotsuki","Shimotsuki"];

			}
			case 7:{
				// 9.13
				Texts = ["Why is it usually white?", "The snow never stopped", "But today it is red then", "Because...", "Because the flake is red", "Why it is white?", "The snow never stopped", "But yesterday it was red then", "Because...", "The flake is red only today"];
				Names = ["Kawako", "Shimotsuki", "Tsuruko", "Shimotsuki", "Nizaemon","Kawako","Shimotsuki","Tsuruko","Shimotsuki","Shimotsuki"];
			}
