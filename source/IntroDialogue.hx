	...
	public function chooseDialogue(Option:Int):Void{
		...
		switch dialogueIndex {
			case 1: {
				...
				"You are the only family I have and that is the way you think of me?","No, but you are selling your soul.", "At least I am not risking my life！","No you are not, and I have never heard of a Yujo who is 30 and still alive!", "You are already 43 now my sister.", "After this, we would have enough money to live anywhere else.",
			...
			case 6:{
				// GE
				Texts = ["Why is it usually white?", "The snow never stopped.", "But today it is red then?", "Because...", "Because the flake is red."];
				Names = ["Kawako", "Shimotsuki", "Tsuruko", "Shimotsuki", "Nizaemon"];
				
			}
			case 7:{
				//be
				Texts = ["Why it is white?", "The snow never stopped.", "But yesterday it was red then?", "Because...", "The flake is red only today..."];
				Names=["Kawako","Shimotsuki","Tsuruko","Shimotsuki","Shimotsuki"];
			}
